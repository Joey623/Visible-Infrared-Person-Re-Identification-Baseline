...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152',
           'ResNetUnfold', 'resnet18unfold', 'resnet34unfold', 'resnet50unfold', 'resnet101unfold', 'resnet152unfold']
...
class ResNet(nn.Module):
    def __init__(self, block, layers, last_stride=1):
        self.inplanes = 64
    ...
    def load_param(self, pretrained_weights):
        ...
        for i in pretrained_dict:
            if 'fc' in i:
                continue
            self.state_dict()[i].copy_(pretrained_dict[i])
